...
/**
 * author: zhaoqiang
 * date:2017/09/30 / 21:54
 * zhaoqiang:zhaoq_hero@163.com
 *
 * 自定义 圆形 ImageView
 */
public class MRoundImageView extends android.support.v7.widget.AppCompatImageView {
    /**
    ...
    public MRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //取xml文件中设定的参数
